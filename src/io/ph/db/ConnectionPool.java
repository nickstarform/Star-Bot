...
public class ConnectionPool {
     ...
     * @return Connection to this guild's database
     */
    public static Connection getConnectionQuote(String guildId) throws SQLException {
        try {
            Class.forName("org.sqlite.JDBC");
            return DriverManager.getConnection("jdbc:sqlite:resources/guilds/" + guildId + "/Quote.db");
        } catch(SQLTimeoutException e) {
            e.printStackTrace();
        } catch (ClassNotFoundException e) {
            e.printStackTrace();
