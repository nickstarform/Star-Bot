...
define_tables = {
    ...
    CREATE TABLE IF NOT EXISTS schema.guilds (
        guild_id BIGINT,
        prefix varchar(2),
        voicerole_enabled BOOLEAN DEFAULT FALSE,
        discordinvites_allowed BOOLEAN DEFAULT TRUE,
        voicelog_enabled BOOLEAN DEFAULT FALSE,
        modlog_enabled BOOLEAN DEFAULT FALSE,
        genlog_enabled BOOLEAN DEFAULT FALSE,
